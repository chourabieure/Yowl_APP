<template>
	<div v-if="currentPost" class="page edit-form">
		<h4>Post</h4>
		<form>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="description" v-model="currentPost.description" />
			</div>
		...
		<button class="badge badge-primary mr-2" v-if="currentPost.published" @click="updatePublished(false)">
			UnPublish
		</button>
